  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">CRMS</span>
      </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item" >
        <a class="nav-link"  href="drivers">
          <i class="bi bi-person"></i><span>Drivers</span>
       ...
       <li class="nav-item" >
        <a class="nav-link"  href="bookings">
          <i class="bi bi-person"></i><span>Bookings</span>
      ...
      <li class="nav-item" >
        <a class="nav-link"  href="users">
          <i class="bi bi-person"></i><span>Admin Users</span>
...
<li class="nav-item">
     ...
     <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="product-expense">
              <i class="bi bi-circle"></i><span>Product reports</span>
            </a>
          </li>
          <li>
            <a href="report-history">
              <i class="bi bi-circle"></i><span>Report History</span>
            </a>
          </li>
        </ul>
      </li><!-- End Charts Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-gem"></i><span>Bookings / Orders</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
