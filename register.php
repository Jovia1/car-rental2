                  ...
                  <form method='POST' action='' class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Please enter your full username.</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control" id="yourpass" required>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name='register_btn'>Login</button>
                    </div>
